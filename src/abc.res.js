...
var match = newrecord.name;

var isGita = match === "gitanjli" ? true : false;

console.log(isGita);

var isAge = newrecord.age === 23;

console.log(isAge);

var nameWasSet = newrecord.name !== undefined;

console.log(nameWasSet);

var E = {
  me: me,
  maybeName: maybeName,
  without_name: newrecord,
  isGita: isGita,
  isAge: isAge,
